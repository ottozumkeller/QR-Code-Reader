...
powershell -command "&{ps2exe.ps1 ..\Source\actions.ps1 ..\Source\actions.exe -iconFile ..\Source\qr_reader.ico -title 'QR-Code Reader URI Handler' -version 1.0.0 -product 'QR-Code Reader URI Handler' -copyright 'Copyright Otto Zumkeller 2023' -noConsole -noOutput}"
